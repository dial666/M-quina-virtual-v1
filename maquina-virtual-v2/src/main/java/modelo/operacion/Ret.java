 ...
 * @author valen
 */
public class Ret implements IOperacion
{

    @Override
    public void ejecutar(Operando opA, Operando opB, UnidadIO mv) throws VMException
    {
        IOperacion operacionPop = new Pop();
        operacionPop.ejecutar(new OperandoRegistroE(ConstantesRegistros.IP.getCodigo()), opB, mv);
    }
