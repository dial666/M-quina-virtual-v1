\doxysection{src/mem\+\_\+reg\+\_\+io.c File Reference}
\hypertarget{mem__reg__io_8c}{}\label{mem__reg__io_8c}\index{src/mem\_reg\_io.c@{src/mem\_reg\_io.c}}
...
\item 
void \mbox{\hyperlink{mem__reg__io_8c_aa010f44596d0fa5c3d4dce05a82687bb}{cargar\+LAR}} (int dir\+Logica, int registros\mbox{[}$\,$\mbox{]})
\begin{DoxyCompactList}\small\item\em Carga en el LAR una dirección lógica. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{mem__reg__io_8c_a778e4d867cd66ddf146858a366f4ad7b}{verificar\+Indice\+Segmento}} (int indice\+Segmento, int tabla\+Segmentos\mbox{[}$\,$\mbox{]})
...
void \mbox{\hyperlink{mem__reg__io_8c_a99cf75399d343c71fff04fe960c2a7cd}{cargar\+MAR}} (int cant\+Bytes, int registros\mbox{[}$\,$\mbox{]}, int tabla\+Segmentos\mbox{[}$\,$\mbox{]})
...
void \mbox{\hyperlink{mem__reg__io_8c_ac9d4b807b38dddb8abc7edf82b388550}{leer\+Memoria}} (char memoria\mbox{[}$\,$\mbox{]}, int registros\mbox{[}$\,$\mbox{]})
\begin{DoxyCompactList}\small\item\em Pone en MBR un valor leído de memoria. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{mem__reg__io_8c_a44997b88e824e02b6294b66cb0996487}{cargar\+MBR}} (int registros\mbox{[}$\,$\mbox{]}, int valor)
\begin{DoxyCompactList}\small\item\em Pone en MBR un valor. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{mem__reg__io_8c_a41ea255192acabf6dd7f780121b37f14}{escribir\+Memoria}} (char memoria\mbox{[}$\,$\mbox{]}, int registros\mbox{[}$\,$\mbox{]}, int tabla\+Segmentos\mbox{[}$\,$\mbox{]})
\begin{DoxyCompactList}\small\item\em Pone en las celdas de memoria un valor guardado en MBR. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{mem__reg__io_8c_a63487f3a7043da9bc09e1b74f573360f}{store}} (char memoria\mbox{[}$\,$\mbox{]}, int registros\mbox{[}$\,$\mbox{]}, int tabla\+Segmentos\mbox{[}$\,$\mbox{]}, int dir\+Logica, int cant\+Bytes, int valor)
...
void \mbox{\hyperlink{mem__reg__io_8c_a142a0be58eacd01a390d94bf02df0507}{verificar\+Indice\+Registro}} (int index\+Reg)
\begin{DoxyCompactList}\small\item\em Valida que un registro exista. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{mem__reg__io_8c_af5259b4c87007a85287a673355ea4c1f}{escribir\+Memoria\+Registro}} (char memoria\mbox{[}$\,$\mbox{]}, int registros\mbox{[}$\,$\mbox{]}, int tabla\+Segmentos\mbox{[}$\,$\mbox{]}, int operando, int valor)
\begin{DoxyCompactList}\small\item\em Escribe en un registro o en memoria un valor. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{mem__reg__io_8c_ac080994299f6d8112dd340dd502bad95}{Operandoto\+Inmediato}} (int operando, char memoria\mbox{[}$\,$\mbox{]}, int registros\mbox{[}$\,$\mbox{]}, int tabla\+Segmentos\mbox{[}$\,$\mbox{]})
\begin{DoxyCompactList}\small\item\em Obtiene el valor de un operando. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{mem__reg__io_8c_aa79c8d366a3dd450a0101838665a3e20}{fetch}} (char memoria\mbox{[}$\,$\mbox{]}, int registros\mbox{[}$\,$\mbox{]}, int tabla\+Segmentos\mbox{[}$\,$\mbox{]}, int dir\+Logica, int cant\+Bytes)
...
\Hypertarget{mem__reg__io_8c_doc-func-members}
\doxysubsection{Function Documentation}
\Hypertarget{mem__reg__io_8c_aa010f44596d0fa5c3d4dce05a82687bb}\index{mem\_reg\_io.c@{mem\_reg\_io.c}!cargarLAR@{cargarLAR}}
\index{cargarLAR@{cargarLAR}!mem\_reg\_io.c@{mem\_reg\_io.c}}
\doxysubsubsection{\texorpdfstring{cargarLAR()}{cargarLAR()}}
{\footnotesize\ttfamily \label{mem__reg__io_8c_aa010f44596d0fa5c3d4dce05a82687bb} 
...
\hline
\end{DoxyParams}
\Hypertarget{mem__reg__io_8c_a99cf75399d343c71fff04fe960c2a7cd}\index{mem\_reg\_io.c@{mem\_reg\_io.c}!cargarMAR@{cargarMAR}}
\index{cargarMAR@{cargarMAR}!mem\_reg\_io.c@{mem\_reg\_io.c}}
\doxysubsubsection{\texorpdfstring{cargarMAR()}{cargarMAR()}}
{\footnotesize\ttfamily \label{mem__reg__io_8c_a99cf75399d343c71fff04fe960c2a7cd} 
...
\end{DoxyPrecond}
\Hypertarget{mem__reg__io_8c_a44997b88e824e02b6294b66cb0996487}\index{mem\_reg\_io.c@{mem\_reg\_io.c}!cargarMBR@{cargarMBR}}
\index{cargarMBR@{cargarMBR}!mem\_reg\_io.c@{mem\_reg\_io.c}}
\doxysubsubsection{\texorpdfstring{cargarMBR()}{cargarMBR()}}
{\footnotesize\ttfamily \label{mem__reg__io_8c_a44997b88e824e02b6294b66cb0996487} 
...
\end{DoxySeeAlso}
\Hypertarget{mem__reg__io_8c_a41ea255192acabf6dd7f780121b37f14}\index{mem\_reg\_io.c@{mem\_reg\_io.c}!escribirMemoria@{escribirMemoria}}
\index{escribirMemoria@{escribirMemoria}!mem\_reg\_io.c@{mem\_reg\_io.c}}
\doxysubsubsection{\texorpdfstring{escribirMemoria()}{escribirMemoria()}}
{\footnotesize\ttfamily \label{mem__reg__io_8c_a41ea255192acabf6dd7f780121b37f14} 
...
\end{DoxyPrecond}
\Hypertarget{mem__reg__io_8c_af5259b4c87007a85287a673355ea4c1f}\index{mem\_reg\_io.c@{mem\_reg\_io.c}!escribirMemoriaRegistro@{escribirMemoriaRegistro}}
\index{escribirMemoriaRegistro@{escribirMemoriaRegistro}!mem\_reg\_io.c@{mem\_reg\_io.c}}
\doxysubsubsection{\texorpdfstring{escribirMemoriaRegistro()}{escribirMemoriaRegistro()}}
{\footnotesize\ttfamily \label{mem__reg__io_8c_af5259b4c87007a85287a673355ea4c1f} 
...
\end{DoxyPrecond}
\Hypertarget{mem__reg__io_8c_aa79c8d366a3dd450a0101838665a3e20}\index{mem\_reg\_io.c@{mem\_reg\_io.c}!fetch@{fetch}}
\index{fetch@{fetch}!mem\_reg\_io.c@{mem\_reg\_io.c}}
\doxysubsubsection{\texorpdfstring{fetch()}{fetch()}}
{\footnotesize\ttfamily \label{mem__reg__io_8c_aa79c8d366a3dd450a0101838665a3e20} 
...
\hline
\end{DoxyParams}
\Hypertarget{mem__reg__io_8c_ac9d4b807b38dddb8abc7edf82b388550}\index{mem\_reg\_io.c@{mem\_reg\_io.c}!leerMemoria@{leerMemoria}}
\index{leerMemoria@{leerMemoria}!mem\_reg\_io.c@{mem\_reg\_io.c}}
\doxysubsubsection{\texorpdfstring{leerMemoria()}{leerMemoria()}}
{\footnotesize\ttfamily \label{mem__reg__io_8c_ac9d4b807b38dddb8abc7edf82b388550} 
...
En MAR debe haber en los 2 bytes más significativos la cantidad de bytes a leer y en los otros 2 una dirección física válida. 
\end{DoxyPrecond}
\Hypertarget{mem__reg__io_8c_ac080994299f6d8112dd340dd502bad95}\index{mem\_reg\_io.c@{mem\_reg\_io.c}!OperandotoInmediato@{OperandotoInmediato}}
\index{OperandotoInmediato@{OperandotoInmediato}!mem\_reg\_io.c@{mem\_reg\_io.c}}
\doxysubsubsection{\texorpdfstring{OperandotoInmediato()}{OperandotoInmediato()}}
{\footnotesize\ttfamily \label{mem__reg__io_8c_ac080994299f6d8112dd340dd502bad95} 
...
\end{DoxyReturn}
\Hypertarget{mem__reg__io_8c_a63487f3a7043da9bc09e1b74f573360f}\index{mem\_reg\_io.c@{mem\_reg\_io.c}!store@{store}}
\index{store@{store}!mem\_reg\_io.c@{mem\_reg\_io.c}}
\doxysubsubsection{\texorpdfstring{store()}{store()}}
{\footnotesize\ttfamily \label{mem__reg__io_8c_a63487f3a7043da9bc09e1b74f573360f} 
...
cant\+Bytes debe ser menor o igual a 4. 
\end{DoxyPrecond}
\Hypertarget{mem__reg__io_8c_a142a0be58eacd01a390d94bf02df0507}\index{mem\_reg\_io.c@{mem\_reg\_io.c}!verificarIndiceRegistro@{verificarIndiceRegistro}}
\index{verificarIndiceRegistro@{verificarIndiceRegistro}!mem\_reg\_io.c@{mem\_reg\_io.c}}
\doxysubsubsection{\texorpdfstring{verificarIndiceRegistro()}{verificarIndiceRegistro()}}
{\footnotesize\ttfamily \label{mem__reg__io_8c_a142a0be58eacd01a390d94bf02df0507} 
...
\hline
\end{DoxyParams}
\Hypertarget{mem__reg__io_8c_a778e4d867cd66ddf146858a366f4ad7b}\index{mem\_reg\_io.c@{mem\_reg\_io.c}!verificarIndiceSegmento@{verificarIndiceSegmento}}
\index{verificarIndiceSegmento@{verificarIndiceSegmento}!mem\_reg\_io.c@{mem\_reg\_io.c}}
\doxysubsubsection{\texorpdfstring{verificarIndiceSegmento()}{verificarIndiceSegmento()}}
{\footnotesize\ttfamily \label{mem__reg__io_8c_a778e4d867cd66ddf146858a366f4ad7b} 
